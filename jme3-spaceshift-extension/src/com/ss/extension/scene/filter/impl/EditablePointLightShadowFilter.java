 ...
 * @author JavaSaBr
 */
public class EditablePointLightShadowFilter extends PointLightShadowFilter
    ...
    public Array<EditableProperty<?, ?>> getEditableProperties() {
        ...
        result.add(new SimpleProperty<>(EditablePropertyType.ENUM, "Edge filtering mode", this,
                EditablePointLightShadowFilter::getEdgeFilteringMode, EditablePointLightShadowFilter::setEdgeFilteringMode));
        result.add(new SimpleProperty<>(EditablePropertyType.ENUM, "Shadow compare mode", this,
                EditablePointLightShadowFilter::getShadowCompareMode, EditablePointLightShadowFilter::setShadowCompareMode));
        result.add(new SimpleProperty<>(EditablePropertyType.FLOAT, "Shadow z extend", this,
                EditablePointLightShadowFilter::getShadowZExtend, EditablePointLightShadowFilter::setShadowZExtend));
        result.add(new SimpleProperty<>(EditablePropertyType.FLOAT, "Shadow z fade length", this,
                EditablePointLightShadowFilter::getShadowZFadeLength, EditablePointLightShadowFilter::setShadowZFadeLength));
        result.add(new SimpleProperty<>(EditablePropertyType.FLOAT, "Shadow intensity", this,
                EditablePointLightShadowFilter::getShadowIntensity, EditablePointLightShadowFilter::setShadowIntensity));
        result.add(new SimpleProperty<>(EditablePropertyType.INTEGER, "Edges thickness", this,
                EditablePointLightShadowFilter::getEdgesThickness, EditablePointLightShadowFilter::setEdgesThickness));
        result.add(new SimpleProperty<>(EditablePropertyType.BOOLEAN, "Back faces shadows", this,
                EditablePointLightShadowFilter::isRenderBackFacesShadows, EditablePointLightShadowFilter::setRenderBackFacesShadows));
