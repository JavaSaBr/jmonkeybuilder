...
public class EditorLightNode extends Node {
    ...
    public void updateGeometricState() {
        ...
        if (light instanceof PointLight) {
            ...
            directionalLight.setDirection(rotation.getRotationColumn(2, directionalLight.getDirection()));
        } else if (light instanceof SpotLight) {
            final SpotLight spotLight = (SpotLight) light;
            final Quaternion rotation = getLocalRotation();
            final Vector3f direction = rotation.getRotationColumn(2, spotLight.getDirection());
