 ...
 * @author JavaSaBr
 */
public class PointLightElementPropertyControl<D> extends AbstractElementFilterPropertyControl<D, PointLight> {

    public PointLightElementPropertyControl(@Nullable final PointLight propertyValue,
