...
/**
 * Реализация контрола по редактированию направления света.
 *
 * @author Ronn
 */
public class DirectionLightPropertyControl<T extends Light> extends ModelPropertyControl<T, Vector3f> {
    ...
    public DirectionLightPropertyControl(final Vector3f element, final String paramName, final ModelChangeConsumer modelChangeConsumer) {
