 ...
 * @author JavaSaBr
 */
public class ParticleEmittersPropertyBuilder extends AbstractPropertyBuilder<ModelChangeConsumer> {
    ...
    @NotNull
    private static final PropertyBuilder INSTANCE = new ParticleEmittersPropertyBuilder();
    ...
    private ParticleEmittersPropertyBuilder() {
    ...
    private void buildFor(@NotNull final VBox container, @NotNull final ModelChangeConsumer changeConsumer,
        ...
        faceNormalControl.setSyncHandler(ParticleEmitter::getFaceNormal);
