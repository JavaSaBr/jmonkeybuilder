 ...
 * @author JavaSaBr
 */
public class QuadShapeEmitterAction extends AbstractNodeAction {

    public QuadShapeEmitterAction(@NotNull final ModelNodeTree nodeTree, @NotNull final ModelNode<?> node) {
        super(nodeTree, node);
    }
