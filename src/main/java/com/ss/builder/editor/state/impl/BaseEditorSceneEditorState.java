...
public abstract class BaseEditorSceneEditorState extends Editor3dWithEditorToolEditorState {
    ...
    public BaseEditorSceneEditorState() {
        ...
        this.transformationMode = EditorTransformSupport.TransformationMode.GLOBAL.ordinal();
        this.transformationType = EditorTransformSupport.TransformType.MOVE_TOOL.ordinal();
    }
