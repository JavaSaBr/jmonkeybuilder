...
import static com.ss.builder.FileExtensions.TEXTURE_EXTENSIONS;
...
import com.ss.builder.fx.tooltip.ImageChannelPreview;
...
public class Texture2dPropertyControl<C extends ChangeConsumer, D> extends PropertyControl<C, D, Texture2D> {
    ...
    protected void addNewTexture() {
        UiUtils.openFileAssetDialog(this::changeTexture, FileExtensions.TEXTURE_EXTENSIONS, DEFAULT_ACTION_TESTER);
    }
