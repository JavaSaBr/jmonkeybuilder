package com.ss.builder.fx.control.tree;

import static com.ss.rlib.common.util.ObjectUtils.notNull;
import com.ss.builder.annotation.FxThread;
import com.ss.builder.fx.control.tree.node.TreeNode;
import com.ss.builder.fx.control.tree.node.factory.TreeNodeFactoryRegistry;
...
public class NodeTree<C extends ChangeConsumer> extends VBox {
    ...
    public void refresh(@NotNull Object object) {
        ...
        var treeItem = UiUtils.findItemForValue(getTreeView(), object);
        if (treeItem == null) {
            return;
        }
    ...
    public void update(@NotNull TreeNode<?> treeNode) {
        ...
        var treeItem = UiUtils.findItemForValue(getTreeView(), treeNode);
        if (treeItem == null) {
            return;
        }
    ...
    private void notifyMoved(
        ...
        var treeView = getTreeView();
        var prevParentItem = UiUtils.findItemForValue(treeView, prevParent);
        var newParentItem = UiUtils.findItemForValue(treeView, newParent);
        var nodeItem = UiUtils.findItemForValue(treeView, node);
    ...
    public void notifyReplace(@Nullable final Object parent, @Nullable final Object oldChild,
        ...
        final TreeItem<TreeNode<?>> oldChildItem = oldChild == null ? null : UiUtils.findItemForValue(treeView, oldChild);
    ...
    public @Nullable TreeNode<?> findParent(@NotNull final TreeNode<?> treeNode) {
        ...
        final TreeItem<TreeNode<?>> treeItem = UiUtils.findItemForValue(getTreeView(), treeNode);
        if (treeItem == null) {
            return null;
        }
