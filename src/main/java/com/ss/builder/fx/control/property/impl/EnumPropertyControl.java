...
import static com.ss.builder.util.EditorUtils.getAvailableValues;
...
public class EnumPropertyControl<C extends ChangeConsumer, D, E extends Enum<?>> extends PropertyControl<C, D, E> {
    ...
    public EnumPropertyControl(
        ...
        this(propertyValue, propertyName, changeConsumer, EditorUtils.getAvailableValues(propertyValue), null);
    }
