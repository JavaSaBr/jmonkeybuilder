...
import static com.ss.builder.Messages.MODEL_NODE_TREE_ACTION_ADD_CONTROL;
import static com.ss.builder.Messages.MODEL_NODE_TREE_ACTION_CREATE;
import static com.ss.builder.jme.editor.part3d.impl.scene.AbstractSceneEditor3dPart.KEY_MODEL_NODE;
...
import com.ss.builder.model.undo.impl.MoveControlOperation;
import com.ss.builder.model.undo.impl.RenameNodeOperation;
import com.ss.builder.fx.Icons;
import com.ss.builder.fx.control.model.ModelNodeTree;
import com.ss.builder.fx.control.tree.action.impl.AddUserDataAction;
import com.ss.builder.fx.control.tree.action.impl.DisableAllControlsAction;
import com.ss.builder.fx.control.tree.action.impl.EnableAllControlsAction;
import com.ss.builder.fx.control.tree.action.impl.RemoveNodeAction;
import com.ss.builder.fx.control.tree.action.impl.control.CreateCustomControlAction;
import com.ss.builder.fx.control.tree.action.impl.control.CreateLightControlAction;
import com.ss.builder.fx.control.tree.action.impl.control.CreateMotionControlAction;
import com.ss.builder.fx.control.tree.action.impl.control.physics.CreateCharacterControlAction;
import com.ss.builder.fx.control.tree.action.impl.control.physics.CreateRigidBodyControlAction;
import com.ss.builder.fx.control.tree.action.impl.control.physics.CreateStaticRigidBodyControlAction;
import com.ss.builder.fx.control.tree.action.impl.control.physics.vehicle.CreateVehicleControlAction;
...
import com.ss.builder.fx.control.tree.node.impl.light.LightTreeNode;
import com.ss.builder.util.ControlUtils;
import com.ss.builder.util.NodeUtils;
...
public class SpatialTreeNode<T extends Spatial> extends TreeNode<T> {
    ...
    public boolean canRemove() {
        ...
        return parent != null && parent.getUserData(AbstractSceneEditor3dPart.KEY_MODEL_NODE) != Boolean.TRUE;
    }
    ...
    protected @NotNull Optional<Menu> createCreationMenu(@NotNull NodeTree<?> nodeTree) {
        ...
        var menu = new Menu(Messages.MODEL_NODE_TREE_ACTION_CREATE, new ImageView(Icons.ADD_12));
        var createControlMenu = new Menu(Messages.MODEL_NODE_TREE_ACTION_ADD_CONTROL, new ImageView(Icons.ADD_12));
