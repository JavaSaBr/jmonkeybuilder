package com.ss.builder.fx.component.editor.area;
...
import com.ss.builder.fx.component.editor.event.HideFileEditorEvent;
import com.ss.builder.fx.component.editor.event.ShowedFileEditorEvent;
...
import com.ss.builder.fx.component.editor.event.ClosedFileEditorEvent;
import com.ss.builder.fx.component.editor.event.FileRenamedFileEditorEvent;
import com.ss.builder.fx.component.editor.event.HideFileEditorEvent;
import com.ss.builder.fx.component.editor.event.ShowedFileEditorEvent;
import com.ss.builder.fx.css.CssIds;
import com.ss.builder.fx.dialog.ConfirmDialog;
...
public class EditorAreaComponent extends TabPane implements ScreenComponent {
    ...
    private void addEditor(@NotNull FileEditor editor, boolean needShow) {
        ...
        tab.setGraphic(new ImageView(iconManager.getIcon(editFile, FileIconManager.DEFAULT_FILE_ICON_SIZE)));
