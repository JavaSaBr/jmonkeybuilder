...
import com.ss.builder.fx.component.painting.property.PaintingPropertyDefinition;
import com.ss.builder.fx.component.painting.property.PropertiesBasedPaintingComponent;
...
public class SpawnPaintingComponent extends
    ...
    private static final SpawnToolControl.SpawnMethod[] SPAWN_METHODS = SpawnToolControl.SpawnMethod.values();
    ...
    protected void syncValues(@NotNull SpawnPaintingStateWithEditorTool state, @NotNull SpawnToolControl toolControl) {
        ...
        toolControl.setMethod(SpawnToolControl.SpawnMethod.valueOf(state.getMethod()));
