...
import com.ss.builder.ui.component.asset.tree.resource.LoadingResourceElement;
...
public class ResourceTreeCell extends TreeCell<ResourceElement> {
    ...
    protected void updateItem(@Nullable ResourceElement item, boolean empty) {
        ...
        icon.setImage(ICON_MANAGER.getIcon(file, folder, true, FileIconManager.DEFAULT_FILE_ICON_SIZE));
