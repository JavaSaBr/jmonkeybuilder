...
import static com.ss.builder.fx.util.UiUtils.toWeb;
...
public class PluginsDialog extends AbstractSimpleEditorDialog {
    ...
    private @NotNull String generateDescription(@Nullable EditorPlugin plugin) {
        ...
        if (backgroundColor != null && fontColor != null && linkColor != null) {
            ...
            result.append("body{background-color:").append(UiUtils.toWeb(backgroundColor)).append(";}");
            result.append("h2{color:").append(UiUtils.toWeb(fontColor)).append(";}");
            result.append("h3{color:").append(UiUtils.toWeb(fontColor)).append(";}");
            result.append("h4{color:").append(UiUtils.toWeb(fontColor)).append(";}");
            result.append("p{color:").append(UiUtils.toWeb(fontColor)).append(";}");
            result.append("pre{color:").append(UiUtils.toWeb(fontColor)).append(";}");
            result.append("a{color:").append(UiUtils.toWeb(linkColor)).append(";}");
            result.append("</style>");
            result.append("</head>");
        }
