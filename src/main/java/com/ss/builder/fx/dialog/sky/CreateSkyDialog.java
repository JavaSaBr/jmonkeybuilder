...
import com.ss.builder.fx.control.choose.ChooseFolderControl;
import com.ss.builder.fx.control.choose.ChooseTextureControl;
...
public class CreateSkyDialog extends AbstractSimpleEditorDialog {
    ...
    /**
     * Get the container of single texture settings.
     *
    ...
    /**
     * Get the container of multiply texture settings.
     *
    ...
    /**
     * Get the single texture control.
     *
    ...
    /**
     * Get the material folder control.
     *
    ...
    /**
     * Get the bottom texture control.
     *
    ...
    /**
     * Get the check box for flipping.
     *
