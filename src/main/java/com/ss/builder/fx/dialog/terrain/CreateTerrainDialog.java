package com.ss.builder.ui.dialog.terrain;
...
import com.ss.builder.ui.control.choose.ChooseFolderControl;
import com.ss.builder.ui.control.choose.ChooseTextureControl;
import com.ss.builder.ui.control.tree.NodeTree;
    ...
    private void createTerrainInBackground() throws Exception {
        ...
        switch (heightMapType) {
            ...
            case IMAGE_BASED: {
                ...
                final Path assetFile = notNull(EditorUtils.getAssetFile(heightMapTextureFile));
                final Texture texture = assetManager.loadTexture(EditorUtils.toAssetPath(assetFile));
        ...
        for (int i = 0; i < NUM_ALPHA_TEXTURES; i++) {
            ...
            final Texture texture = assetManager.loadAsset(new TextureKey(EditorUtils.toAssetPath(assetFile), false));
        ...
        final Texture baseTexture = assetManager.loadTexture(EditorUtils.toAssetPath(notNull(EditorUtils.getAssetFile(baseTextureFile))));
        ...
        terrainNode.setUserData(AbstractSceneEditor3dPart.KEY_LOADED_MODEL, true);
