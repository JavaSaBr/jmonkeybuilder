package com.ss.builder.ui.dialog.animation;
...
import com.ss.builder.model.undo.impl.animation.AddAnimationNodeOperation;
import com.ss.builder.ui.control.tree.NodeTree;
import com.ss.builder.ui.control.tree.node.impl.control.legacyanim.AnimationTreeNode;
...
public class ExtractSubAnimationDialog extends AbstractSimpleEditorDialog {
    ...
    private void processExtract() {
        ...
        final Animation subAnimation = AnimationUtils.extractAnimation(animation, nameField.getText(), startFrame, endFrame);
