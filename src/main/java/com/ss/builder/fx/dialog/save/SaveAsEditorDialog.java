package com.ss.builder.fx.dialog.save;

import static com.ss.builder.Messages.SAVE_AS_EDITOR_DIALOG_FIELD_FILENAME;
import static com.ss.builder.Messages.SAVE_AS_EDITOR_DIALOG_TITLE;
...
import com.ss.builder.fx.event.impl.CreatedFileEvent;
