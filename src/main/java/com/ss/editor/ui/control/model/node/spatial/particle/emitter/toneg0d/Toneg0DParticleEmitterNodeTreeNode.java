 ...
 * @author JavaSaBr
 */
public class Toneg0DParticleEmitterNodeTreeNode extends NodeTreeNode<ParticleEmitterNode> {
     ...
     */
    public Toneg0DParticleEmitterNodeTreeNode(@NotNull final ParticleEmitterNode element, final long objectId) {
    ...
    public Array<TreeNode<?>> getChildren(@NotNull final NodeTree<?> nodeTree) {
        ...
        children.add(FACTORY_REGISTRY.createFor(new Toneg0dParticleInfluencers(element)));
